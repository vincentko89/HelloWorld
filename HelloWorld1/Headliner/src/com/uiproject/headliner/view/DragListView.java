package com.uiproject.headliner.view;

import java.util.HashMap;

import com.uiproject.headliner.DragListActivity.DragListAdapter;
...
public class DragListView extends ListView {
	...
	public boolean onInterceptTouchEvent(MotionEvent ev) {
		if (ev.getAction() == MotionEvent.ACTION_DOWN) {
			...
			View dragger = itemView.findViewById(R.id.item_image);
	...
	public void onDrop(int y) {
		...
		if (dragPosition > 0 && dragPosition < getAdapter().getCount()) {
			...
			HashMap<String, Object> dragItem = adapter.getItem(dragSrcPosition);
